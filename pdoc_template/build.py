...
- The two collages and the logo (`collage.py`) are regenerated from those same
  runs, and copied into `docs/`, where the package page and the examples page show the
  collages, and every page's sidebar the smiley.
...
# The collages and the logo: regenerated at the repo root (where the README wants
